...
import 'primary_rounded_button_model.dart';
export 'primary_rounded_button_model.dart';

class PrimaryRoundedButtonWidget extends StatefulWidget {
  const PrimaryRoundedButtonWidget({
    Key? key,
    String? buttonText,
    Color? buttonBgColor,
  ...
  @override
  _PrimaryRoundedButtonWidgetState createState() =>
      _PrimaryRoundedButtonWidgetState();
}

class _PrimaryRoundedButtonWidgetState
    extends State<PrimaryRoundedButtonWidget> {
  late PrimaryRoundedButtonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PrimaryRoundedButtonModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FFButtonWidget(
      onPressed: widget.disableStatusPara
          ? null
          : () async {
              logFirebaseEvent('PRIMARY_ROUNDED_BUTTON_BUTTON_BTN_ON_TAP');
      ...
      options: FFButtonOptions(
        ...
        textStyle: FlutterFlowTheme.of(context).labelSmall.override(
              ...
              fontSize: widget.buttonTextSize.toDouble(),
