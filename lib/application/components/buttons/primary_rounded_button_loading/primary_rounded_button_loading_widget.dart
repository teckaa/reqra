...
import 'primary_rounded_button_loading_model.dart';
export 'primary_rounded_button_loading_model.dart';

class PrimaryRoundedButtonLoadingWidget extends StatefulWidget {
  const PrimaryRoundedButtonLoadingWidget({
    Key? key,
    String? buttonText,
    Color? buttonBgColor,
  ...
  @override
  _PrimaryRoundedButtonLoadingWidgetState createState() =>
      _PrimaryRoundedButtonLoadingWidgetState();
}

class _PrimaryRoundedButtonLoadingWidgetState
    extends State<PrimaryRoundedButtonLoadingWidget> {
  late PrimaryRoundedButtonLoadingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PrimaryRoundedButtonLoadingModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FFButtonWidget(
      onPressed: widget.disableStatusPara
          ? null
          : () async {
              logFirebaseEvent('PRIMARY_ROUNDED_BUTTON_LOADING_BUTTON_BT');
