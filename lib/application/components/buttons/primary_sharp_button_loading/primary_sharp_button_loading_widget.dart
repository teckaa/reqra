...
import 'primary_sharp_button_loading_model.dart';
export 'primary_sharp_button_loading_model.dart';

class PrimarySharpButtonLoadingWidget extends StatefulWidget {
  const PrimarySharpButtonLoadingWidget({
    Key? key,
    String? buttonText,
    Color? buttonBgColor,
  ...
  @override
  _PrimarySharpButtonLoadingWidgetState createState() =>
      _PrimarySharpButtonLoadingWidgetState();
}

class _PrimarySharpButtonLoadingWidgetState
    extends State<PrimarySharpButtonLoadingWidget> {
  late PrimarySharpButtonLoadingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PrimarySharpButtonLoadingModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FFButtonWidget(
      onPressed: widget.disableStatusPara
          ? null
          : () async {
              logFirebaseEvent('PRIMARY_SHARP_BUTTON_LOADING_BUTTON_BTN_');
