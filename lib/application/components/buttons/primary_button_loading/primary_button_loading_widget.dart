...
import 'primary_button_loading_model.dart';
export 'primary_button_loading_model.dart';

class PrimaryButtonLoadingWidget extends StatefulWidget {
  ...
  @override
  _PrimaryButtonLoadingWidgetState createState() =>
      _PrimaryButtonLoadingWidgetState();
}

class _PrimaryButtonLoadingWidgetState
    extends State<PrimaryButtonLoadingWidget> {
  late PrimaryButtonLoadingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PrimaryButtonLoadingModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FFButtonWidget(
      onPressed: widget.disableStatusPara
          ? null
          : () async {
              logFirebaseEvent('PRIMARY_BUTTON_LOADING_BUTTON_BTN_ON_TAP');
