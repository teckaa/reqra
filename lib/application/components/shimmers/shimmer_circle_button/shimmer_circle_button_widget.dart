...
import 'shimmer_circle_button_model.dart';
export 'shimmer_circle_button_model.dart';

class ShimmerCircleButtonWidget extends StatefulWidget {
  const ShimmerCircleButtonWidget({
    Key? key,
    int? buttonWidth,
    int? buttonHeight,
    int? numberOfButton,
  ...
  @override
  _ShimmerCircleButtonWidgetState createState() =>
      _ShimmerCircleButtonWidgetState();
}

class _ShimmerCircleButtonWidgetState extends State<ShimmerCircleButtonWidget>
    with TickerProviderStateMixin {
  late ShimmerCircleButtonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShimmerCircleButtonModel());
