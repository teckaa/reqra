...
import 'number_text_field_model.dart';
export 'number_text_field_model.dart';
...
class NumberTextFieldWidget extends StatefulWidget {
  ...
  @override
  _NumberTextFieldWidgetState createState() => _NumberTextFieldWidgetState();
}

class _NumberTextFieldWidgetState extends State<NumberTextFieldWidget> {
  late NumberTextFieldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NumberTextFieldModel());
        ...
        children: [
          ...
          TextFormField(
            ...
            onChanged: (_) => EasyDebounce.debounce(
              ...
              () async {
                logFirebaseEvent('NUMBER_TEXT_FIELD_TextField_pszqeib7_ON_');
