...
import 'amount_text_field_model.dart';
export 'amount_text_field_model.dart';
...
class _AmountTextFieldWidgetState extends State<AmountTextFieldWidget> {
  late AmountTextFieldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AmountTextFieldModel());
        ...
        children: [
          ...
          TextFormField(
            ...
            onChanged: (_) => EasyDebounce.debounce(
              ...
              () async {
                logFirebaseEvent('AMOUNT_TEXT_FIELD_TextField_1fpjihap_ON_');
