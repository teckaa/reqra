...
import 'url_text_field_model.dart';
export 'url_text_field_model.dart';

class UrlTextFieldWidget extends StatefulWidget {
  ...
  @override
  _UrlTextFieldWidgetState createState() => _UrlTextFieldWidgetState();
}

class _UrlTextFieldWidgetState extends State<UrlTextFieldWidget> {
  late UrlTextFieldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UrlTextFieldModel());
          ...
          Container(
            ...
            child: TextFormField(
              ...
              onChanged: (_) => EasyDebounce.debounce(
                ...
                () async {
                  logFirebaseEvent('URL_TEXT_FIELD_TextField_97q0a51g_ON_TEX');
