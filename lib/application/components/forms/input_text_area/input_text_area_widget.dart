...
import 'input_text_area_model.dart';
export 'input_text_area_model.dart';
...
class _InputTextAreaWidgetState extends State<InputTextAreaWidget> {
  late InputTextAreaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InputTextAreaModel());
        ...
        children: [
          ...
          TextFormField(
            ...
            onChanged: (_) => EasyDebounce.debounce(
              ...
              () async {
                logFirebaseEvent('INPUT_TEXT_AREA_TextField_i9vqynyv_ON_TE');
