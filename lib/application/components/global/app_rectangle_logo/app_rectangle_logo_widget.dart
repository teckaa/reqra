...
import 'app_rectangle_logo_model.dart';
export 'app_rectangle_logo_model.dart';

class AppRectangleLogoWidget extends StatefulWidget {
  const AppRectangleLogoWidget({
    Key? key,
    int? photoWidth,
    this.photoHeight,
  ...
  @override
  _AppRectangleLogoWidgetState createState() => _AppRectangleLogoWidgetState();
}

class _AppRectangleLogoWidgetState extends State<AppRectangleLogoWidget> {
  late AppRectangleLogoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppRectangleLogoModel());
          ...
          child: PhotoGridWidget(
            ...
            photoPath:
                (Theme.of(context).brightness == Brightness.light) == true
                    ? photoGridDwAppRecord?.appLightRectangleLogo
                    : photoGridDwAppRecord?.appDarkRectangleLogo,
            photoName: 'Logo',
