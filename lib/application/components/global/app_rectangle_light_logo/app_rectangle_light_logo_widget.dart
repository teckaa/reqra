...
import 'app_rectangle_light_logo_model.dart';
export 'app_rectangle_light_logo_model.dart';

class AppRectangleLightLogoWidget extends StatefulWidget {
  const AppRectangleLightLogoWidget({
    Key? key,
    int? photoWidth,
    this.photoHeight,
  ...
  @override
  _AppRectangleLightLogoWidgetState createState() =>
      _AppRectangleLightLogoWidgetState();
}

class _AppRectangleLightLogoWidgetState
    extends State<AppRectangleLightLogoWidget> {
  late AppRectangleLightLogoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppRectangleLightLogoModel());
      ...
      builder: (context, snapshot) {
        ...
        return wrapWithModel(
          ...
          child: PhotoGridWidget(
            ...
            photoPath: photoGridDwAppRecord?.appLightRectangleLogo,
            photoName: 'Logo',
