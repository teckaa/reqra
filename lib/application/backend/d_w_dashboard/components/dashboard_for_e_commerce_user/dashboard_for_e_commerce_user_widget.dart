...
import 'dashboard_for_e_commerce_user_model.dart';
export 'dashboard_for_e_commerce_user_model.dart';

class DashboardForECommerceUserWidget extends StatefulWidget {
  const DashboardForECommerceUserWidget({
    Key? key,
  ...
  @override
  _DashboardForECommerceUserWidgetState createState() =>
      _DashboardForECommerceUserWidgetState();
}

class _DashboardForECommerceUserWidgetState
    extends State<DashboardForECommerceUserWidget> {
  late DashboardForECommerceUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardForECommerceUserModel());
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              ...
              onTap: () async {
                logFirebaseEvent('DASHBOARD_FOR_E_COMMERCE_USER_Row-AllOrd');
