...
import 'virtual_card_model.dart';
export 'virtual_card_model.dart';
...
class _VirtualCardWidgetState extends State<VirtualCardWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VirtualCardModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'VirtualCard'});
              ...
              desktop: false,
                ...
                ? AppBar(
                    ...
                    leading: FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'VIRTUAL_CARD_PAGE_arrowLeft2_ICN_ON_TAP');
                                                  ...
                                                  Builder(
                                                    builder: (context) =>
                                                      ...
                                                      child:
                                                        ...
                                                        buttonAction: () async {
                                                          logFirebaseEvent(
                                                              'VIRTUAL_CARD_Container_jukwto7f_CALLBACK');
                                                          logFirebaseEvent(
                                                  ...
                                                  Builder(
                                                    builder: (context) =>
                                                      ...
                                                      child:
                                                        ...
                                                        buttonAction: () async {
                                                          logFirebaseEvent(
                                                              'VIRTUAL_CARD_Container_35xsq86b_CALLBACK');
                                                          logFirebaseEvent(
                                                              'PrimaryButton_alert_dialog');
                                                          await showAlignedDialog(
                                                            context: context,
                                                                ...
                                                                child:
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    modalTitlePara:
                                                                        'Freeze Card',
                                                                    modalDescPara:
                                                                        'Are you sure you want to put this card on hold? While this card is frozen, you will be unable to make any payments.',
                                                                    cancelBtnTextPara:
                                                                        'No, Cancel',
                                                                    confirmBtnTextPara:
                                                                        'Yes, Freeze',
                                                  ...
                                                  Builder(
                                                    builder: (context) =>
                                                      ...
                                                      child:
                                                        ...
                                                        buttonAction: () async {
                                                          logFirebaseEvent(
                                                              'VIRTUAL_CARD_Container_eid6qeok_CALLBACK');
                                                          logFirebaseEvent(
                                                              'PrimaryButton_alert_dialog');
                                                          await showAlignedDialog(
                                                            context: context,
