...
import 'create_plugin_widget.dart' show CreatePluginWidget;
...
class CreatePluginModel extends FlutterFlowModel<CreatePluginWidget> {
  ///  State fields for stateful widgets in this component.

  final formKey = GlobalKey<FormState>();
  // Model for ModalHeader component.
  late ModalHeaderModel modalHeaderModel;
  // Model for InputTextField-PluginName.
  late InputTextFieldModel inputTextFieldPluginNameModel;
  // Model for InputTextArea-PluginDesc.
  late InputTextAreaModel inputTextAreaPluginDescModel;
  ...
  void initState(BuildContext context) {
    ...
    inputTextFieldPluginNameModel.textControllerValidator =
        _formTextFieldValidator1;
    inputTextAreaPluginDescModel.textControllerValidator =
        _formTextFieldValidator2;
  }

  void dispose() {
    modalHeaderModel.dispose();
    inputTextFieldPluginNameModel.dispose();
    inputTextAreaPluginDescModel.dispose();
  ...
  String? _formTextFieldValidator1(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'zqeyv4j3' /* Plugin name is required */,
      );
    }
  ...
  String? _formTextFieldValidator2(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '359eu2gz' /* Plugin description is required */,
      );
    }
