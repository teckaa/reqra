...
import 'create_product_category_model.dart';
export 'create_product_category_model.dart';

class CreateProductCategoryWidget extends StatefulWidget {
  const CreateProductCategoryWidget({Key? key}) : super(key: key);

  @override
  _CreateProductCategoryWidgetState createState() =>
      _CreateProductCategoryWidgetState();
}

class _CreateProductCategoryWidgetState
    extends State<CreateProductCategoryWidget> with TickerProviderStateMixin {
  late CreateProductCategoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateProductCategoryModel());
          ...
          children: [
            wrapWithModel(
              ...
              child: ModalHeaderWidget(
                headerTitlePara: 'Add Product Category',
              ...
              child: Form(
                ...
                child: wrapWithModel(
                  ...
                  child: CategoryComposerWidget(
                    ...
                    btnAction: () async {
                      logFirebaseEvent(
                          'CREATE_PRODUCT_CATEGORY_Container_jjkiib');
            ...
            wrapWithModel(
              ...
              child: ModalFooterRowWidget(
                ...
                proceedActionPara: () async {
                  logFirebaseEvent('CREATE_PRODUCT_CATEGORY_Container_ipy9x7');
