...
class _CreateAirtimeWidgetState extends State<CreateAirtimeWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('CreateAirtime_firestore_query');
                                                                    ...
                                                                    children: List.generate(
                                                                      ...
                                                                      return InkWell(
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'CREATE_AIRTIME_PAGE_Card_2mkbqmha_ON_TAP');
                                                                          logFirebaseEvent(
                                                                              'Card_update_page_state');
                                                                          setState(
                                                                              () {
                                                                            _model.providerRef =
                                                                                rowBillpaymentProvidersRecord.reference;
                                                                          });
                                                                        },
                                                                        child:
                                                                            Card(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            key:
                                                                                Key('Key3k3_${rowIndex}_of_${rowBillpaymentProvidersRecordList.length}'),
                                                                            photoWidth:
                                                                                50,
                                                                            photoHeight:
                                                                                50,
                                                            ...
                                                            Row(
                                                              ...
                                                              crossAxisAlignment:
                                                                  CrossAxisAlignment
                                                                      .end,
                                                              children: [
                                                                if (columnBillpaymentProvidersRecord
                                                                            .providerBillerCode !=
                                                                        null &&
                                                                    columnBillpaymentProvidersRecord
                                                                            .providerBillerCode !=
                                                                        '')
                                                                  Card(
                                                                    clipBehavior:
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Builder(
                                                                        builder:
                                                                            (context) {
                                                                          final listOfAmount =
                                                                              containerBillpaymentsServicesRecord?.serviceAmountPicker?.toList() ?? [];
                                                                          return SingleChildScrollView(
                                                                            scrollDirection:
                                                                                Axis.horizontal,
                                                                            child:
                                                                      ...
                                                                      AuthUserStreamWidget(
                                                                        builder:
                                                                          ...
                                                                          'Balance: ${valueOrDefault(currentUserDocument?.currency, '')} ${formatNumber(
                                                                            valueOrDefault(currentUserDocument?.accountBalance,
                                                                                0.0),
                                                                            formatType:
                                                                                FormatType.decimal,
                                                                            decimalType:
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            focusNode:
                                                                                _model.textFieldAmountFocusNode,
                                                                            onChanged: (_) =>
                                                                            ...
                                                                            validator:
                                                                                _model.textFieldAmountControllerValidator.asValidator(context),
                                                                            inputFormatters: [
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    disableStatusPara: (_model.textFieldPhoneNumberController.text == null || _model.textFieldPhoneNumberController.text == '') ||
                                                                        (columnBillpaymentProvidersRecord.providerServiceType ==
                                                                            ...
                                                                            columnBillpaymentProvidersRecord.providerServiceType ==
                                                                                '') ||
                                                                        ((_model.textFieldAmountController.text == null || _model.textFieldAmountController.text == '') ||
