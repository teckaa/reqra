...
import 'create_theme_model.dart';
export 'create_theme_model.dart';

class CreateThemeWidget extends StatefulWidget {
  const CreateThemeWidget({Key? key}) : super(key: key);

  @override
  _CreateThemeWidgetState createState() => _CreateThemeWidgetState();
}

class _CreateThemeWidgetState extends State<CreateThemeWidget>
    with TickerProviderStateMixin {
  late CreateThemeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateThemeModel());
            ...
            children: [
              wrapWithModel(
                ...
                child: ModalHeaderWidget(
                  headerTitlePara: 'Create Theme',
                  headerActionPara: () async {
                    logFirebaseEvent(
                        'CREATE_THEME_Container_e9mc4sph_CALLBACK');
              ...
              Form(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      wrapWithModel(
                        model: _model.inputTextFieldThemeNameModel,
                        updateCallback: () => setState(() {}),
                        updateOnChange: true,
                        child: InputTextFieldWidget(
                          labelPara: 'Theme Name',
                          hintPara: 'Theme Name',
                      ...
                      wrapWithModel(
                        model: _model.inputTextAreaThemeDescModel,
                        updateCallback: () => setState(() {}),
                        updateOnChange: true,
                        child: InputTextAreaWidget(
                          labelPara: 'Theme Description',
                          readOnlyStatusPara: false,
                          actionPara: () async {},
                        ),
                      ),
                        ...
                        children: [
                          Text(
                            FFLocalizations.of(context).getText(
                              'kw9g5vqr' /* Theme Image Size (420 by 150) */,
                            ),
                              ...
                              Expanded(
                                child: Builder(
                                  builder: (context) => InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'CREATE_THEME_Container_g11bhfac_ON_TAP');
                                      logFirebaseEvent(
                      ...
                      wrapWithModel(
                        ...
                        child: PrimaryButtonLoadingWidget(
                          ...
                          disableStatusPara: (_model
                                          ...
                                          .text ==
                                      null ||
                                  _model.inputTextFieldThemeNameModel
                                          .textController.text ==
                                      '') ||
                              (_model.inputTextAreaThemeDescModel.textController
                                          .text ==
                                      null ||
                                  _model.inputTextAreaThemeDescModel
                                          .textController.text ==
                                      ''),
                          disableColorPara:
                          ...
                          buttonAction: () async {
                            logFirebaseEvent(
                                'CREATE_THEME_Container_kmzmqja6_CALLBACK');
                            ...
                            unawaited(
                              () async {
                                await DwThemesRecord.collection
                                    .doc()
                                    .set(createDwThemesRecordData(
                                      themeName: _model
                                          .inputTextFieldThemeNameModel
                                          .textController
                                          .text,
                                      themeDesc: _model
                                          ...
                                          .textController
                                          .text,
                                      themePhoto: _model.getImageData,
                                    ));
                              }(),
                            );
                            logFirebaseEvent(
