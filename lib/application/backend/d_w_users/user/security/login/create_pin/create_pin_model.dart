...
class CreatePinModel extends FlutterFlowModel<CreatePinWidget> {
  ...
  String? _formTextFieldValidator23(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '2s1vqb8y' /* Confirm pin is required */,
      );
    }
    ...
    if (val.length > 6) {
      return FFLocalizations.of(context).getText(
        '7tid9txh' /* Confirm pin must be 6 digits */,
      );
    }
  ...
  String? _formTextFieldValidator11(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'ueuqlvxt' /* Pin is required */,
      );
    }

    if (val.length < 6) {
      return FFLocalizations.of(context).getText(
        '2t4zf9er' /* Pin must be 6 digits */,
      );
    }
    if (val.length > 6) {
      return FFLocalizations.of(context).getText(
        'u9q5bwl1' /* Pin must be 6 digits */,
      );
    }
  ...
  String? _formTextFieldValidator12(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '5k1jie2z' /* Confirm pin is required */,
      );
    }

    if (val.length < 6) {
      return FFLocalizations.of(context).getText(
        'f682u6a5' /* Confirm pin must be 6 digits */,
      );
    }
    if (val.length > 6) {
      return FFLocalizations.of(context).getText(
        'r94c9og0' /* Confirm pin must be 6 digits */,
      );
    }
