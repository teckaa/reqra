              ...
              desktop: false,
                ...
                ? AppBar(
                    ...
                    leading: FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent('SECURITY_PAGE_arrowLeft2_ICN_ON_TAP');
                                        ...
                                        children: [
                                          wrapWithModel(
                                            ...
                                            child: TitleWithBackButtonWidget(
                                              ...
                                              actionPara: () async {
                                                logFirebaseEvent(
                                                    'SECURITY_Container_9vdkc03a_CALLBACK');
                                                logFirebaseEvent(
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SECURITY_Container-ChangePassword_ON_TAP');
                                              logFirebaseEvent(
                                                  'Container-ChangePassword_navigate_to');
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SECURITY_Container-SecurityPin_ON_TAP');
                                              logFirebaseEvent(
                                                  'Container-SecurityPin_navigate_to');
