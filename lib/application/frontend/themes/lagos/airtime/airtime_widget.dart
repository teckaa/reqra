...
class _AirtimeWidgetState extends State<AirtimeWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Airtime'});
                                          ...
                                          Padding(
                                            ...
                                            child: SelectionArea(
                                              ...
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '2lq7mqdu' /* Enjoy the ease of topping up y... */,
                                              ),
                                              style:
                                          ...
                                          Padding(
                                            ...
                                            child: wrapWithModel(
                                              ...
                                              child: PrimaryRoundedButtonWidget(
                                                ...
                                                buttonAction: () async {
                                                  logFirebaseEvent(
                                                      'AIRTIME_PAGE_Container_owcp1m8n_CALLBACK');
                                                  logFirebaseEvent(
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        '3py2edmg' /* Convenient Airtime Top-Up */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .displayLarge
                                          .override(
                                    ...
                                    Padding(
                                      ...
                                      child: SelectionArea(
                                          child: Text(
                                        FFLocalizations.of(context).getText(
                                          'd06ztx62' /* Stay effortlessly connected wi... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
