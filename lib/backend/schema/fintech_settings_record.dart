...
class FintechSettingsRecord extends FirestoreRecord {
  FintechSettingsRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('fintech_settings');

  static Stream<FintechSettingsRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => FintechSettingsRecord.fromSnapshot(s));

  static Future<FintechSettingsRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => FintechSettingsRecord.fromSnapshot(s));

  static FintechSettingsRecord fromSnapshot(DocumentSnapshot snapshot) =>
      FintechSettingsRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static FintechSettingsRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      FintechSettingsRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'FintechSettingsRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is FintechSettingsRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createFintechSettingsRecordData({
  DateTime? createdAt,
...
class FintechSettingsRecordDocumentEquality
    implements Equality<FintechSettingsRecord> {
  const FintechSettingsRecordDocumentEquality();

  @override
  bool equals(FintechSettingsRecord? e1, FintechSettingsRecord? e2) {
  ...
  @override
  int hash(FintechSettingsRecord? e) => const ListEquality().hash([
        e?.createdAt,
        e?.userRef,
        e?.permitSelling,
        e?.permitBuying,
  ...
  @override
  bool isValidKey(Object? o) => o is FintechSettingsRecord;
}
