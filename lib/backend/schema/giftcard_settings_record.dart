...
class GiftcardSettingsRecord extends FirestoreRecord {
  GiftcardSettingsRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('giftcard_settings');

  static Stream<GiftcardSettingsRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => GiftcardSettingsRecord.fromSnapshot(s));

  static Future<GiftcardSettingsRecord> getDocumentOnce(
          DocumentReference ref) =>
      ref.get().then((s) => GiftcardSettingsRecord.fromSnapshot(s));

  static GiftcardSettingsRecord fromSnapshot(DocumentSnapshot snapshot) =>
      GiftcardSettingsRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static GiftcardSettingsRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      GiftcardSettingsRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'GiftcardSettingsRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is GiftcardSettingsRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createGiftcardSettingsRecordData({
  DateTime? createdAt,
...
class GiftcardSettingsRecordDocumentEquality
    implements Equality<GiftcardSettingsRecord> {
  const GiftcardSettingsRecordDocumentEquality();

  @override
  bool equals(GiftcardSettingsRecord? e1, GiftcardSettingsRecord? e2) {
  ...
  @override
  int hash(GiftcardSettingsRecord? e) => const ListEquality().hash([
        e?.createdAt,
        e?.userRef,
        e?.permitSelling,
        e?.permitBuying,
  ...
  @override
  bool isValidKey(Object? o) => o is GiftcardSettingsRecord;
}
