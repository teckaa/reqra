...
class EcommerceSettingsRecord extends FirestoreRecord {
  EcommerceSettingsRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('ecommerce_settings');

  static Stream<EcommerceSettingsRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => EcommerceSettingsRecord.fromSnapshot(s));

  static Future<EcommerceSettingsRecord> getDocumentOnce(
          DocumentReference ref) =>
      ref.get().then((s) => EcommerceSettingsRecord.fromSnapshot(s));

  static EcommerceSettingsRecord fromSnapshot(DocumentSnapshot snapshot) =>
      EcommerceSettingsRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static EcommerceSettingsRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      EcommerceSettingsRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'EcommerceSettingsRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is EcommerceSettingsRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createEcommerceSettingsRecordData({
  DateTime? createdAt,
...
class EcommerceSettingsRecordDocumentEquality
    implements Equality<EcommerceSettingsRecord> {
  const EcommerceSettingsRecordDocumentEquality();

  @override
  bool equals(EcommerceSettingsRecord? e1, EcommerceSettingsRecord? e2) {
  ...
  @override
  int hash(EcommerceSettingsRecord? e) => const ListEquality().hash([
        e?.createdAt,
        e?.userRef,
        e?.permitSelling,
        e?.permitBuying,
  ...
  @override
  bool isValidKey(Object? o) => o is EcommerceSettingsRecord;
}
